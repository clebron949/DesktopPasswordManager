...
const props = withDefaults(defineProps<ClipboardIconProps>(), {
  className: "size-6", // Default value for className, using size-6
});

// Destructure props to directly use className in the template.
